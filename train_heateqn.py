...
def main():
    ...
    num_input_filters = {
        'u_p_net': [filter_size,filter_size,filter_size],
        'u_net': [filter_size],
        'u_net_noskip': [filter_size],
    }
    ...
    skip_connection_handling = {
        'u_p_net': 'concatenate',
        'u_net': 'concatenate',
        'u_net_noskip': 'no_skip_connections',
    }
    ...
    if name in skip_connection_handling:
        skip_connection_handling = skip_connection_handling[name]
    else:
        skip_connection_handling = skip_connection_handling['u_p_net']
    ...
    config['training']['output_folder'] = 'data/model_heatequation/'+config['training']['filename_base']+'_after_'+str(config['training']['epochs'])+'epochs'
    ...
    config['model']['skip_connection_handling'] = skip_connection_handling
    config['model']['pooling_handling']         = 'max_pooling'
    config['model']['normalization_handling']   = None
    ...
    config['model']['inputs_dangling']          = [0, 0, 0, 0]
