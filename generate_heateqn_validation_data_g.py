...
config['filename_base'] = 'dataset_validation_g'
...
# base expressions
config['no_domain_material_expression_value'] = 1.5
...
# inclusionConfig['width'] = config['dx']*2*24
# inclusionConfig['height'] = config['dx']*2*64
# inclusionConfig['center_x'] = config['dx']*(50)
# inclusionConfig['center_y'] = config['dx']*(64)
inclusionConfig['width'] = config['dx']*86
inclusionConfig['height'] = config['dx']*128
inclusionConfig['center_x'] = config['dx']*(43)
inclusionConfig['center_y'] = config['root']['center_y']
