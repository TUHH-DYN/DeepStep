...
inclusionConfig['center_x'] = config['root']['center_x'] + config['root']['width']/2.0
inclusionConfig['center_y'] = config['root']['center_y'] + config['root']['height']/2.0
...
inclusionConfig['width'] = config['dx']*2*45
inclusionConfig['height'] = config['dx']*2*45
inclusionConfig['center_x'] = config['root']['center_x'] - config['root']['width']/2.0
inclusionConfig['center_y'] = config['root']['center_y'] - config['root']['height']/2.0
...
config['initial_condition']['center_x'] = config['dx']*(128-10)
config['initial_condition']['center_y'] = config['dx']*(64-10)
