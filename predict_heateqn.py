...
validation_case = 'f' # inner rect. bc + rect. inhomog. + linear root bc 
# validation_case = 'g' # inner H-shaped bc (with variable bc-values) + linear root bc 
# validation_case = 'h' # inner circle-shaped bc + linear root bc 
# validation_case = 'i' # inner rect. inhomog. + linear root bc 
...
# config['prediciton']['timesteps']             = 100

config['prediciton']['iterative_feedback']    = True 
...
config['prediciton']['output_folder']         = 'data/prediction_heatequation'
...
config['model']['folder'] = 'data/model_heatequation'
...
config['data'] = {}
config['data']['folder'] = 'data/datasets_test_heatequation'
...
print('# total prediction took {:.4E}s'.format(end - start))
