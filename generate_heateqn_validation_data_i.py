...
inclusionConfig['width'] = config['dx']*2*100
inclusionConfig['height'] = config['dx']*2*2
inclusionConfig['center_x'] = config['dx']*(128)
inclusionConfig['center_y'] = config['dx']*(22+14)
...
inclusionConfig['height'] = config['dx']*2*2
inclusionConfig['center_x'] = config['dx']*(128)
inclusionConfig['center_y'] = config['dx']*(128-22-14)
...
# temperatures for constant bc of inclusion domain
inclusionConfig['f'] = 0.25

inclusionConfig['width'] = config['dx']*2*2
inclusionConfig['height'] = config['dx']*2*16
inclusionConfig['center_x'] = config['dx']*(128)
