...
config['filename_base'] = 'dataset_validation_f'
...
# base expressions
config['no_domain_material_expression_value'] = 1.25
...
# material parameter
inclusionConfig['k'] = 0.75
# inclusionConfig['f'] = 0.4

inclusionConfig['width'] = config['dx']*2*25
inclusionConfig['height'] = config['dx']*2*25
inclusionConfig['center_x'] = config['dx']*(128)
inclusionConfig['center_y'] = config['dx']*(64)
...
inclusionConfig['center_x'] = config['dx']*(60)
inclusionConfig['center_y'] = config['dx']*(54)
...
# temperatures for constant bc of inclusion domain
inclusionConfig['f'] = 0.2

inclusionConfig['width'] = config['dx']*2*16
inclusionConfig['height'] = config['dx']*2*30
inclusionConfig['center_x'] = config['dx']*(204)
inclusionConfig['center_y'] = config['dx']*(66)
