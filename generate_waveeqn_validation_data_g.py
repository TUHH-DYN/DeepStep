...
# material inclusion material parameter (0.5-2)
inclusionConfig['k'] = 0.625
...
config['initial_condition']['center_x'] = config['root']['center_x']
config['initial_condition']['center_y'] = config['root']['center_y']
